...
/**
 * Allowed values for the ECS `event.category` array — a closed set, per the ECS spec. The second
 * level of the ECS categorisation hierarchy (kind > category > type): e.g. outbound API telemetry
 * carries `api`, credential exchanges carry `authentication`.
 *
